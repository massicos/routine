	...
	function TableauBordView(famille) {
	    ...
	    function affichageInitial(tableauBord)
	    {
	    	...
	    	for (var i = 0; i < max; i++) {
                ...
                $(routineAffichage).find(".nbrMedailles").text(2);
                var sousTotalMedailles = 2 * famille.getMontantParSuccesComplet();
